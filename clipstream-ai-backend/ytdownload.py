...
This module provides functionality for downloading YouTube videos using pytubefix.
...
def download_youtube_video(url: str, output_path: str | None = None):
    ...
    Args:
        ...
        output_path: Optional path for saving the video (defaults to current directory)
